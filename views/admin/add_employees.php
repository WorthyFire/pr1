    ...
    <div class="add_employees_content_block">
        ...
        <form method="post" class="form_add_employees">
            <div class="fields_form">
                <input class="field_add_employees" type="text" name="login" placeholder="Логин" required>
                <input class="field_add_employees" type="password" name="password" placeholder="Пароль" required>
            </div>
